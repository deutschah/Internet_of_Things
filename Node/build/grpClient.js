...
const DataClient = protoDescriptor.GrpcServer.Data;
// Create the client instance
const grpcClient = new DataClient('dotnet-service:5000', grpc.credentials.createInsecure()); // Adjust the host and port if necessary
